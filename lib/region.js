...
module.exports = () => {
  ...
  let create_foreign_internal_object = null;
  return {
    internal_value_of: (external_value) => {
      if (external_value && typeof external_value === "object" || typeof external_value === "function") {
        ...
        if (!foreign_internal_object) {
          foreign_internal_object = create_foreign_internal_object(external_value);
    ...
    resolve_create_foreign_internal_object: (closure) => create_foreign_internal_object = closure
  };
};
