...
module.exports = (membrane) => {
  ...
  advice.eval = ($$value, serial) => {
    if (membrane.instrument)
      return membrane.instrument(String(release(membrane.leave($$value))), serial);
    throw new Error("Either membrane.instrument must be defined or advice.eval must be overwritten.");
  }
